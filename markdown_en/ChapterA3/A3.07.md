...
table is reproduced from N.A.O.A. Technical note
\\#575, "Estimation of moments of inertia of airplanes
from Design Data."
...
Column (1) of Table 6a gives breakdown of airplane
units or items.

Column (2) gives the weight of each item.
...
have relatively large values for their centroidal
moments of inertia.
...
through the c.go of airplane. The values are
obtained as follows:

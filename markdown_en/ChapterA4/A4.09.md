...
speed. The normal force coefficient ( $C_{Z_{A}}$ ) can
be assumed to vary linearly With the angle of
attack. Thus in Fig. (a), let point (B) represent th~ normal airplane force coefficient  $C_{Z_{A}}$ 
necessary to maintain level flight With a
velocity V and point (C) the value of  $C_{Z_{A}}$  after
...
From Fig. (b) for small angles, $\Delta a = KU/V$
and from Fig. (a), $\Delta C_{Z_{A}} = m \Delta a,$ where m = the
slope of the airplane normal force curve ( $C_{Z_{A}}$  per radian).
...
change in  $C_{Z_{A}}$  with respect to angle of attack

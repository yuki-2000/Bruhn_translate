...
(1) Compute Fc = P/A for the given number.


(2) With this value of Fc enter the basic
column curve diagram for the given material (for
end fixity C = 1) and find value of $L'/\rho $ corresponding to the stress Fc.





(3) Using these values of $L'/\rho $ and Fc,
compute

...
図A3.5に示すストリンガー断面の水平重心軸に対する慣性モーメントを求めよ。
...
図A3.5aに示すフライホイールの回転軸周りの慣性モーメントを求めよ。
材質はアルミニウム合金鋳物（比重 = 0.1ポンド/立方インチ）である。
...
スポークは細長い円柱とみなすことができ、リムとハブは中空円筒とみなすことができる。（表2参照）

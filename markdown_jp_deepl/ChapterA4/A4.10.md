...
generally referred to as the Velocity-acceleration diagram. The results of the above specification would be similar to that of Fig. A4.14.
...
would give an acceleration less than the limited values given by lines AB and CD.


The positive and negative gust accelerations due to a 30 ft./sec. gust normal to flight
path are shown on Fig. A4.14. In this example
...
$\rho _o$ = standard air denSity at sea level

$\rho _a$  = density of air in which Va is attained
